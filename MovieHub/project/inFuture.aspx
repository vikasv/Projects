			...
			<div class="collapse navbar-collapse"
             ...
             <ul class="nav navbar-nav">
              ...
              <li><a href="inTheatres.aspx">In Theatres</a></li>
               <li class="dropdown">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false"> Future Releases <span class="caret"></span></a>
                <ul class="dropdown-menu" role="menu">
                  <li><a href="comingSoon.aspx">Week Releases</a></li>
                  <li class="active"><a href="inFuture.aspx">Future Releases</a></li>
                </ul>
              </li>
